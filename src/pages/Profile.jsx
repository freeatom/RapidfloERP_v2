...
import { User, Mail, Phone, Globe, Lock, Shield, Clock, Activity, Save, Eye, EyeOff, CheckCircle } from 'lucide-react';
        ...
        <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: 20, alignItems: 'flex-start' }}>
                ...
                <div className="card" style={{ padding: 24, textAlign: 'center' }}>
                    <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'var(--gradient-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px', fontSize: 28, fontWeight: 700, color: 'white' }}>
                    ...
                    <div style={{ borderTop: '1px solid var(--border-light)', marginTop: 16, paddingTop: 12 }}>
                        {[{ id: 'profile', label: 'Edit Profile', icon: User }, { id: 'security', label: 'Security', icon: Lock }, { id: 'sessions', label: 'Login History', icon: Clock }]
                            .map(t => (
                ...
                <div>
                    {tab === 'profile' && (
                        <div className="card" style={{ padding: 24 }}>
                            ...
                            <div className="form-row">
                                <div className="form-group"><label className="form-label"><Mail size={14} style={{ marginRight: 4, verticalAlign: 'middle' }} />Email</label><input className="form-input" value={profile?.email || ''} disabled style={{ opacity: 0.6 }} /></div>
                                <div className="form-group"><label className="form-label"><Phone size={14} style={{ marginRight: 4, verticalAlign: 'middle' }} />Phone</label><input className="form-input" value={form.phone || ''} onChange={e => setForm({ ...form, phone: e.target.value })} /></div>
                            </div>
                            <div className="form-row">
                                <div className="form-group">
                                    <label className="form-label"><Globe size={14} style={{ marginRight: 4, verticalAlign: 'middle' }} />Timezone</label>
                                    <select className="form-select" value={form.timezone || 'Asia/Kolkata'} onChange={e => setForm({ ...form, timezone: e.target.value })}>
                                ...
                                <div className="form-group">
                                    ...
                                    <select className="form-select" value={form.locale || 'en'} onChange={e => setForm({ ...form, locale: e.target.value })}>
